<div class="container" style="margin-top: 5rem;">
  ...
  <div class="row">
    ...
    <div class="col-md-6 col-xs-6 btn-group mt-4">
      <button onclick="pindahLaman('stock')" type="button" class="btn text-white" style="height:150px; padding:20px; background-color:#bdc3c7; opacity:0.7;" title="Laporan Stock">
